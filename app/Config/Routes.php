...
$routes->post('dashboard/submissions/delete/(:num)', 'Dashboard::deleteSubmission/$1');
...
$routes->post('dashboard/approve/(:num)', 'Dashboard::approveUser/$1');
$routes->post('dashboard/reject/(:num)', 'Dashboard::rejectUser/$1');
$routes->post('dashboard/delete/(:num)', 'Dashboard::deleteUser/$1');
...
$routes->post('dashboard/agents/delete/(:num)', 'Dashboard::deleteAgent/$1');
...
$routes->post('dashboard/suppliers/delete/(:num)', 'Dashboard::deleteSupplier/$1');
...
$routes->post('dashboard/inquiries/delete/(:num)', 'Dashboard::deleteInquiry/$1');
...
$routes->post('dashboard/buyer/inquiries/delete/(:num)', 'Dashboard::buyerDeleteInquiry/$1');
