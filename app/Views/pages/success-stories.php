    ...
    <div class="container">
        ...
        <div class="row mt-4 sucess-box">
                                                <div class="col-md-4 mb-4">
                                                    <div class="supplier-product-list-box move-on-hover w-100">
                            <img src="https://k1g.337.mytemp.website/uploads/products/product_metal_1_1.jpg" class="w-100" style="height: 220px; object-fit: cover;">
                            <div class="supplier-product-list-content">
                                                                    <p class="supplier-list-info"><b>SATIN PACKAGES LIMITED</b></p>
...
<br><br>Their additional services such as website development, catalog design, and LLC formation are extremely valuable. I would recommend suppliers to try their services, as the platform offers a refreshing approach compared to traditional B2B marketplaces.”
 ...
 <h2 class="h4">Mr. Johnson – CEO &amp; Founder</h2>
      ...
      <div class="col-md-4 mb-4">
                            ...
                            <img src="https://k1g.337.mytemp.website/uploads/products/product_metal_1_1.jpg" class="w-100" style="height: 220px; object-fit: cover;">
                            <div class="supplier-product-list-content">
                                                                    <p class="supplier-list-info"><b>GlobalTech Industrial Supplies</b></p>
