        ...
        <div class="row">
            <div class="Categories-list">
                ...
                <ul>
                    ...
                    <li><a href="<?= base_url('supplier-category/' . $cat['slug']) ?>"> <?= esc($cat['name']) ?></a>
                    </li>
                    <?php endforeach; ?>
            ...
            <div class="top-supplier">
                <div class="top-supplier-main">
                    <div class="d-flex heading align-items-center justify-content-between">
                        ...
                        <a href="<?= base_url('supplier') ?>" class="view-all-link d-flex align-items-center gap-2">
                            View All <img src="<?= base_url('assets/images/arrow-right.svg') ?>"></a>
                    </div>
...
<section class="cta-sec mt-5">
    <div class="cta-sec-content">
        ...
        <p class="text-white">Your dedicated employee from our Head Quarter, responsible for fetching genuine leads for
            your business while <br class="br_hide"> managing your trade account professionally.</p>
        <div>
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs mb-3 gap-2 justify-content-center d-md-none" id="mobilePackageTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="silver-tab" data-bs-toggle="tab" data-bs-target="#silver"
                    type="button" role="tab" aria-controls="silver" aria-selected="true">Starter</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="gold-tab" data-bs-toggle="tab" data-bs-target="#gold" type="button"
                    role="tab" aria-controls="gold" aria-selected="false">Gold</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="platinium-tab" data-bs-toggle="tab" data-bs-target="#platinium"
                    type="button" role="tab" aria-controls="platinium" aria-selected="false">Platinum</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="vip-tab" data-bs-toggle="tab" data-bs-target="#vip" type="button"
                    role="tab" aria-controls="vip" aria-selected="false">VIP</button>
            </li>
        </ul>
                    ...
                    <div class="tab-pane fade show active" id="silver" role="tabpanel" aria-labelledby="silver-tab">
                        <div class="price-box">
                            ...
                            <div class="price-box-content show-more-wrapper" data-visible="5">
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Company
                                        Profile Page
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>10
                                        Showcase Products <br><span class="span-price"> (Front Display
                                            Products)</span></span></p>
                                <p><span><img src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>Special
                                        Product Catalog Page
                                    </span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Buyer's
                                        Database Access
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>Banner
                                        Advertisement
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>BCM
                                        (Buyer Consultant Manager)</span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>International
                                        .COM Website
                                    </span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>WebDomain
                                        & WebHosting
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>Social
                                        Media Marketing
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>Google
                                        SEO (Search Engine Optimization)
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>Logo
                                        Designing

                                    </span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>Stationary
                                        Designing
                                ...
                                <p><span><img
                                            src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>Top-Rated
                                        Verified Buyers

                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>Company
                                        profile PDF/ Product Catalog PDF Designing

                                    </span></p>
                                <button class="show-more-btn">Show More</button>
                            </div>
                            <a class="outline-btn outline-btn-white search-btn btn learn_more_btn mt-3 mx-auto mb-3"
                                href="<?= base_url('premium-services/starter-package') ?>">Learn More</a>
                            <a class="Download_pdf" target="_blank"
                                href="<?= base_url('assets/media/b2b-trade-services-corporate-profile.pdf') ?>">Download
                                PDF</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-pane fade" id="gold" role="tabpanel" aria-labelledby="gold-tab">
                        <div class="price-box gold-price" style="position:relative; overflow:visible;">
                            ...
                            <div class="price-box-content show-more-wrapper" data-visible="5">
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>20
                                        Showcase Products <br><span class="span-price"> (Front Display
                                            Products)</span></span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Special
                                        Product Catalog Page
                                    </span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Buyer's
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>1 BCM
                                        (Buyer Consultant Manager)</span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>International
                                        .COM Website
                                    </span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/wrong-tik.svg') ?>"></span><span>WebDomain
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Logo
                                        Designing
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>(6-8
                                        Buyers/ Month)
                            ...
                            <a class="outline-btn outline-btn-white search-btn btn learn_more_btn mt-3 mx-auto mb-3"
                                href="<?= base_url('premium-services/gold-package') ?>">Learn More</a>
                            <a class="Download_pdf" target="_blank"
                                href="<?= base_url('assets/media/b2b-trade-services-corporate-profile.pdf') ?>">Download
                                PDF</a>
                        </div>
                    ...
                    <div class="tab-pane fade" id="platinium" role="tabpanel" aria-labelledby="platinium-tab">
                        <div class="price-box platinium-price">
                            ...
                            <div class="price-box-content show-more-wrapper" data-visible="5">
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>30
                                        Showcase Products <br><span class="span-price"> (Front Display
                                            Products)</span></span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Special
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Banner
                                        Advertisement
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Team
                                        of 2 BCM (Buyer Consultant Manager)</span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>International
                                        .COM Website
                                    </span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>WebDomain
                                        & WebHosting
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Social
                                        Media Marketing
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>(03
                                        Keywords) Google SEO (Search Engine Optimization)
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Logo
                                        Designing
                                ...
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Stationary
                                        Designing
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>(10-12
                                        Buyers/ Month)
                                        Top-Rated Verified Buyers
                            ...
                            <a class="outline-btn outline-btn-white search-btn btn learn_more_btn mt-3 mx-auto mb-3"
                                href="<?= base_url('premium-services/platinum-package') ?>">Learn More</a>
                            <a class="Download_pdf" target="_blank"
                                href="<?= base_url('assets/media/b2b-trade-services-corporate-profile.pdf') ?>">Download
                                PDF</a>
                        </div>
                    ...
                    <div class="tab-pane fade" id="vip" role="tabpanel" aria-labelledby="vip-tab">
                        <div class="price-box vip-price">
                            ...
                            <div class="price-box-content show-more-wrapper" data-visible="5">
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>50
                                        Showcase Products <br><span class="span-price"> (Front Display
                                            Products)</span></span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Special
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Team
                                        of 3 BCM (Buyer Consultant Manager)</span></p>
                                <p><span><img
                                            src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>International
                                        .COM Website
                                    </span></p>
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>(06
                                        Keywords) Google SEO (Search Engine Optimization)
                                    </span></p>
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>Logo
                                        Designing
                                ...
                                <p><span><img src="<?= base_url('assets/images/right-check.svg') ?>"></span><span>(12-15
                                        Buyers/ Month)
                                        Top-Rated Verified Buyers
                            ...
                            <a class="outline-btn outline-btn-white search-btn btn learn_more_btn mt-3 mx-auto mb-3"
                                href="<?= base_url('premium-services/vip-package') ?>">Learn More</a>
                            <a class="Download_pdf" target="_blank"
                                href="<?= base_url('assets/media/b2b-trade-services-corporate-profile.pdf') ?>">Download
                                PDF</a>
                        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="fetured-supplier">
                <div class="d-flex heading align-items-center justify-content-between">
                    ...
                    <a href="<?= base_url('supplier') ?>" class="view-all-link d-flex align-items-center gap-2"> View
                        All <img src="<?= base_url('assets/images/arrow-right.svg') ?>"></a>
                </div>
                <div class="d-flex gap-2 mt-3 justify-content-between featured-box-row">
                    ...
                    <div class="top-products-box">
                        <div class="top-products-img featured-supplier-logo-wrap">
                            ...
                            <img src="<?= base_url('uploads/suppliers/' . $fs['company_logo']) ?>"
                                class="w-100 featured-supplier-logo"
                                alt="<?= esc($fs['company_name'] ?? ($fs['name'] ?? '')) ?>">
                            <?php else: ?>
                        ...
                        <div class="top-products-content">
                            ...
                            <div class="product-link d-flex justify-content-between align-items-center">
                                <a href="<?= base_url('supplier/profile/' . ($fs['slug'] ?? $fs['id'])) ?>">Learn
                                    More</a> <a
                                    href="<?= base_url('supplier/profile/' . ($fs['slug'] ?? $fs['id'])) ?>"><img
                                        src="<?= base_url('assets/images/down-arrow.svg') ?>"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex gap-2 mt-3 justify-content-between featured-box-row">
                    ...
                    <div class="top-products-box">
                        ...
                        <div class="top-products-content">
                            <h3><?= esc($fp['name']) ?></h3>
                            <p><?= isset($fp['supplier']) ? esc($fp['supplier']['company_name'] ?? $fp['supplier']['name']) : '' ?>
                            </p>
                            <div class="product-link d-flex justify-content-between align-items-center">
                                <a href="<?= base_url('product/detail/' . $fp['id']) ?>">Learn More</a> <a
                                    href="<?= base_url('product/detail/' . $fp['id']) ?>"><img
                                        src="<?= base_url('assets/images/down-arrow.svg') ?>"></a>
                            </div>
                        </div>
                    </div>
...
<section class="mt-5 pt-4 pb-4">
    <div class="container">
        ...
        <p class="text-center">Explore suppliers and products across all categories to find the best match for your
            business needs.</p>
                    ...
                    <div class="row">
                        ...
                        <a href="<?= base_url('supplier-country/' . $c['code']) ?>"
                            ...
                            <div
                                ...
                                <span
                                    style="font-size: 12px; color: #999;"><?= esc(strtoupper($c['code'] ?? '')) ?></span>
                            </div>
                            <?php endif; ?>
                            <p><?= esc($c['name']) ?></p>
                        </a>
        ...
        <div class="row ">
            ...
            <div class="success-stories-col">
                <div class="d-flex heading align-items-center justify-content-between">
                    ...
                    <a href="<?= base_url('success-stories') ?>" class="view-all-link d-flex align-items-center gap-2">
                        View All <img src="<?= base_url('assets/images/arrow-right.svg') ?>"></a>
                </div>
                <div class="success-stories-slider-sec">
                    <div class="success-stories-slider">
                        <div>
                            <p>“B2B Trade Services helped us connect with relevant buyers efficiently. My Business
                                Consultant Manager (BCM) they provided makes it easy to find and filter genuine business
                                leads.
                                <br><br>Their additional services such as website development, catalog design, and LLC
                                formation are extremely valuable. I would recommend suppliers to try their services, as
                                the platform offers a refreshing approach compared to traditional B2B marketplaces.”
                            </p>
                            <p class="client-name mb-1">Mr. Johnson – CEO & Founder</p>
                            <p class="success-stories-compay-name mb-0">SATIN PACKAGES LIMITED</p>
                        </div>
                        <div>
                            <p>“B2B Trade Services has been a valuable platform for expanding our international business
                                network. We started receiving inquiries from buyers in different regions shortly after
                                listing our products.
                                <br><br>The platform’s tools for connecting with potential buyers and managing inquiries
                                are very useful. It has helped us explore new markets and build meaningful business
                        ...
                        <div>
                            <p>“Joining B2B Trade Services has helped increase our product visibility among
                                international buyers. The platform makes it easier to present our products and
                                communicate with companies looking for reliable suppliers.
                                <br><br>We appreciate the professional environment and the opportunities it creates for
                                businesses to connect and grow globally.”
                            </p>
...
<section class="text-center mt-5 mb-5 pt-md-4 pb-md-4">
    <div class="container">
        <h1 class="h2">The World's Leading Global B2B <br> Trading Platform</h1>
        <p>B2B Trade Services LLC is a global B2B marketplace with an extensive experience in wholesale trade solution.
            The platform connects verified buyers and suppliers worldwide, simplifying bulk sourcing through innovative
            e-commerce solutions. With intuitive web and mobile experiences, dedicated support, and trusted traders, B2B
            Trade Services delivers a seamless, reliable, and efficient global trading experience.
...
<script type="application/ld+json">
{
    ...
    "@graph": [{
            "@type": "Organization",
            "@id": "https://b2btradeservices.com/#organization",
            "name": "B2B Trade Services",
            "alternateName": [
                "B2BTradeServices"
            ],
            "url": "https://b2btradeservices.com/",
            "logo": {
                "@type": "ImageObject",
                "@id": "https://b2btradeservices.com/#logo",
                "url": "https://b2btradeservices.com/assets/images/logo.svg"
            },
            "image": "https://b2btradeservices.com/assets/images/logo.svg",
            "email": "info@b2btradeservices.com",
            "description": "B2B Trade Services is a global B2B marketplace connecting manufacturers, suppliers, exporters, wholesalers, and buyers worldwide through international trade and digital business solutions.",
        ...
        {
            "@type": "WebSite",
            "@id": "https://b2btradeservices.com/#website",
            "url": "https://b2btradeservices.com/",
            "name": "B2B Trade Services",
            "publisher": {
                "@id": "https://b2btradeservices.com/#organization"
        ...
        {
            "@type": "WebPage",
            "@id": "https://b2btradeservices.com/#webpage",
            "url": "https://b2btradeservices.com/",
            "name": "B2B Trade Services | Global B2B Marketplace",
            "isPartOf": {
                "@id": "https://b2btradeservices.com/#website"
            },
            "about": {
