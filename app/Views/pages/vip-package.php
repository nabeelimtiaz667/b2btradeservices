        ...
        <div class="row">
            <div class="latest-buy-offer bg-pkg-transparent">
                ...
                <div class="row double-icon-pkg">
                  ...
                  <div class="price-box-content price-box-content-silver-ul   mt-4">
                    <p><span><img src="<?= base_url('assets/images/check-all.svg') ?>"></span><span>Official Company profile Page on our B2B Platform
                    <p><span><img src="<?= base_url('assets/images/check-all.svg') ?>"></span><span>Online Store</span></p>
                    <p><span><img src="<?= base_url('assets/images/check-all.svg') ?>"></span><span>50 Showcase Products (Front Display Products)</span></p>
                    <p><span><img src="<?= base_url('assets/images/check-all.svg') ?>"></span><span>Buyers Database Access</span></p>
                    <p><span><img src="<?= base_url('assets/images/check-all.svg') ?>"></span><span>Team of 03 BCM (Buyer Consultant Managers)</span></p>
                    ...
                    <p><span><img src="<?= base_url('assets/images/check-all.svg') ?>"></span><span>Professional Email Addresses for 10 Users</span></p>
                    ...
                    <p><span><img src="<?= base_url('assets/images/check-all.svg') ?>"></span><span>Google SEO (Top ranking worldwide on 06 Keywords of your products)</span></p>
                    ...
                    <p><span><img src="<?= base_url('assets/images/check-all.svg') ?>"></span><span>13-15 Top-Rated Verified Buyers/Month
</span></p>
                </div>
            ...
            <div class="b2b-top-form single-view-pkg-form">
                <div class="view-pkg-img">
                    <img src="<?= base_url('assets/images/vip-coin.webp') ?>" class="w-100">
                </div>
...
times more Buyers</h2>
                ...
                <form action="<?= base_url('contact/submit') ?>" method="POST">
                    ...
                    <input type="hidden" name="source_page" value="vip-package">
                    ...
                    <div class="radio-join d-flex gap-2 align-items-start">
                        <input type="checkbox" name="agree" id="agree-vip" required><label for="agree-vip"><span style="color: #0F9EA5;">*</span>By joining, I agree to terms of use, privacy policy, IPR and agree to receive emails related to our services.</label>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            ...
            <div class="col-md-6">
                ...
                <p class="mt-3">B2B TRADE SERVICES will design an eye-catching official company VIP MEMBER profile page for your business which will help your buyers to directly get to know more about your company size, products, history and validation.</p>
    ...
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            ...
            <div class="col-md-6">
                ...
                <p class="mt-3">In this VIP Membership Package, you will be able to connect with as many buyers as you want via our platform. No limit to daily messages, hassle free communication and quick conversation options with run-time online active buyers</p>
...
<section class="about-us-intro mt-5">
    <div class="container">
        <div class="row mt-5 align-items-center row-rev-mob">
            <div class="col-md-7">
                <h2>Buyer Consultant Manager (Team of 03 Dedicated Expert):</h2>
...
In this VIP MEMBERSHIP PACKAGE, we will assign a Team of 03 special BCM to you who understands your business, products, buyers’ criteria and target markets. They will work for your company on daily basis (across different time zones) to cater more buyers in different countries.</p>
                  <p>Your TEAM of 3 BCMS will work on following process Regularly:</p>
                  <ul class="checkbox-ul-new premeium-ul mt-3">
                    ...
                    <li>Monthly Reporting and KPI’s Assessment</li>
                </ul>
                  </div>
            <div class="col-md-5">
                <div class="about-us-box-img">
                    <img src="<?= base_url('assets/images/bcm3-pkg.png') ?>" class="w-100">
                </div>
            </div>
        </div>
    </div>
...
<section class="mt-5">
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            <div class="col-md-6">
                <div class="about-us-box-img">
                    <img src="<?= base_url('assets/images/web-vertical.png') ?>" class="w-100">
                </div>
            </div>
            <div class="col-md-6">
                <h2>International .COM Website (Multi Linguistic):</h2>
...
<section class="mt-5">
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            ...
            <div class="col-md-6">
                <h2>Professional  Email Address (10 Users):</h2>
                <p>VIP Membership includes custom business email accounts for five users, enhancing your company’s credibility and communication with international buyers. Professional emails (e.g., name@yourcompany.com) build trust, reinforce your brand, and ensure secure, reliable correspondence for all B2B interactions.</p>
...
<section class="mt-5">
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            ...
            <div class="col-md-6">
                <h2>Banner Advertisement  (Home Page + Supplier Page + Buyer Page + Top Suppliers Listing)</h2>
...
<p>Social Media Marketing helps your business connect with global buyers, build brand awareness, and promote products across major platforms, our social media experts will create your accounts and maintain with weekly postings on all major platforms specially (Facebook, LinkedIn and Instagram)
</p>
               <p>What’s Included:</p>
                <ul class="checkbox-ul-new premeium-ul mt-3">
...
<section class="mt-5">
    <div class="container">
        <div class="row align-items-center text-center text-md-start">
            ...
            <div class="col-md-6">
                <h2> Google SEO  (Search Engine Optimization) – 06 Keywords</h2>
            ...
            <p>Why It’s Important:</p>
             <ul class="checkbox-ul-new premeium-ul mt-3">
                    <li>Optimization for up to 06 targeted product keywords</li>
...
<p>Professional stationery creates a consistent and credible brand image for your business, both online and offline.</p>
   <p>What’s Included:</p>
                <ul class="checkbox-ul-new premeium-ul mt-3">
                    ...
                    <li>Email signature aligned with your brand identity (10 Users)</li>
...
<section class="about-us-intro mt-5">
    <div class="container">
        <div class="row mt-5 align-items-center row-rev-mob">
            <div class="col-md-7">
                <h2>13-15 Top-Rated Verified Buyers/Month</h2>
                <p>In VIP MEMBERSHIP we guarantee you to connect with 13–15 carefully screened and credibility-verified Top Rated international buyers each month, ensuring your business connects only with genuine, high-potential importers actively sourcing products in your category who talks about immediate dealing and bulk orders.</p>
