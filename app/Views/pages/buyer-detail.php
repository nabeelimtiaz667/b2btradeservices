    ...
    <div class="container">
        <div class="row">
            <div class="buyers-left-content">
                <h1 class="font-weight-600 h3"><?= esc($inquiry['title'] ?? 'Buyer Inquiry Details') ?></h1>
                <div class="product-quick-details-list mt-4">
                    ...
                    <div class="d-flex">
                        ...
                        <p class="d-flex gap-2 align-items-center"><?= esc($inquiry['country']['name'] ?? 'N/A') ?>
                            ...
                            <img src="<?= base_url('assets/images/flags/flag_' . str_replace(' ', '_', $inquiry['country']['name']) . '.svg') ?>"
                    ...
                    <div class="d-flex">
                        <p><b>Date Posted:</b></p>
                        <p><?= isset($inquiry['inquiry_date']) ? date('d M, Y', strtotime($inquiry['inquiry_date'])) : date('d M, Y', strtotime($inquiry['created_at'])) ?>
                        </p>
                    </div>
                </div>
            ...
            <div class="buyers-right-content">
                <div class="buy-offer-details">
                    ...
                    <div class="mt-3 mb-3">
                        <img src="<?= base_url('uploads/inquiries/' . $inquiry['attachment']) ?>" alt="Reference Image"
                            style="max-width: 100%; max-height: 300px; object-fit: cover; border-radius: 8px; cursor: pointer;"
                            onclick="window.open(this.src, '_blank')">
                    </div>
                    <?php endif; ?>
                    <div class="dual-btn">
                        <button type="button" class="btn solid-btn contact-buyer-cta" data-bs-toggle="modal"
                    ...
                    <div class="buyers-related-offer-box-content">
                        ...
                        <div class="flag-part">
                            <p class="d-flex align-items-center gap-3">
                                ...
                                <img src="<?= base_url('assets/images/flags/flag_' . str_replace(' ', '_', $related['country']['name']) . '.svg') ?>"
                                    width="20" onerror="this.style.display='none'">
                                <?php endif; ?>
                            </p>
                        </div>
        ...
        <div class="row align-items-end">
            ...
            <div class="success-stories-col">
                <div class="d-flex heading align-items-center justify-content-between">
                    ...
                    <a href="#" class="view-all-link d-flex align-items-center gap-2">View All <img
                            src="<?= base_url('assets/images/arrow-right.svg') ?>"></a>
                </div>
                <div class="success-stories-slider-sec">
                    <div class="success-stories-slider">
                        <div>
                            <p>B2B Trade Services helped us find reliable suppliers from South Asia within days. The
                                platform's lead management system made it easy to track and communicate with multiple
                                vendors simultaneously.</p>
                            <p class="client-name mb-1">Client Name</p>
                            <p class="success-stories-compay-name mb-0">Company</p>
                        </div>
                        <div>
                            <p>As a buyer, I was able to post my requirements and receive quotes from verified suppliers
                                across multiple regions. The process was smooth and the quality of leads exceeded our
                                expectations.</p>
                            <p class="client-name mb-1">Client Name</p>
                            <p class="success-stories-compay-name mb-0">Company</p>
                        </div>
                        <div>
                            <p>The B2B marketplace connected us with premium suppliers we wouldn't have found otherwise.
                                Their verification process gives us confidence in every transaction we make through the
                                platform.</p>
                            <p class="client-name mb-1">Client Name</p>
                            <p class="success-stories-compay-name mb-0">Company</p>
                        </div>
...
<section class="text-center mt-5 mb-5 pt-md-4 pb-md-4">
    <div class="container">
        ...
        <p>B2B Trade Services LLC is a global B2B marketplace with an extensive experience in wholesale trade solution.
            ...
            Trade Services delivers a seamless, reliable, and efficient global trading experience.</p>
            ...
            <div class="modal-body">
                ...
                <form id="popupContactForm" class="popupContactForms">
                    ...
                    <div class="submit-btn text-center">
                        <button type="submit" class="btn solid-btn contact-buyer-cta"
                            style="border: none; cursor: pointer;">Send Information</button>
                    </div>
                </form>
