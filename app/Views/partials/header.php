<div id="sticky-bar" style="display: none;">
    <div class="container">
        <div class="row">
              <div class="stickbar-logo" style="display: none">
         ...
         <div class="main-heading-head ">
                ...
                <div class="radio-search-btn">
                    <div class="filter-group">
                        ...
                        <label>
                            ...
                            <span class="radio"></span> Suppliers
                        </label>
                        <label>
                            <input type="radio" name="type" value="buyers">
                            <span class="radio"></span> Buyers
                        </label>
                        <label>
                            <input type="radio" name="type" value="products">
                            <span class="radio"></span> Products
                        </label>
                    </div>
                </div>
                </form>
            ...
            <div class="mobile_menu_custom" style="display: none;">
                ...
                <nav class="navigation">
                    ...
                    <ul class="navbar-nav">
                       <li class="nav-item"><a class="nav-link text-white exl-btn f-14" href="<?= base_url('premium-services') ?>">Exclusive Services</a></li>
