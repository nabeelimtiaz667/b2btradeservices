    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content multiple-quote-form" style="border:none;">
            ...
            <div class="modal-body pt-0">
                <div id="tsFormSuccess" class="alert alert-success d-none">Thank you! Your application has been submitted. We will contact you shortly.</div>
                <div id="tsFormError" class="alert alert-danger d-none"></div>

                <h2 class="text-center mb-4">Apply Now</h2>
                <form id="tradeshowApplyForm" action="<?= base_url('contact/submit-ajax') ?>" method="POST">
                    <?= csrf_field() ?>
                    <input type="hidden" name="form_type" value="tradeshow_application">
                    <input type="hidden" name="source_page" value="tradeshow-marketing-services">
                    ...
                    <div class="whatsapp-checkbox">
                        <input type="checkbox" name="whatsapp" id="ts_whatsapp" value="1">
                        <label for="ts_whatsapp">Whatsapp <img src="<?= base_url('assets/images/whatsapp-icon.svg') ?>" width="15px"></label>
                    </div>
                    <div class="form-input">
                    ...
                    <div class="form-input selling-field">
                        <div class="multiselect-container">
                            <div class="multiselect-selected" id="multiselect-display" tabindex="0">
                                <span class="placeholder">What type of tradeshow service you want...</span>
                            </div>
                            <div class="multiselect-dropdown" id="multiselect-options">
                                <div class="option" data-value="Want to promote my event">Want to promote my event</div>
                                <div class="option" data-value="Want to participate in event as Exhibitor">Want to participate in event as Exhibitor</div>
                                <div class="option" data-value="Want to participate in event as Buyer">Want to participate in event as Buyer</div>
                                <div class="option" data-value="Want to discuss marketing partnership">Want to discuss marketing partnership</div>
                                <div class="option" data-value="Want to barter tradeshows services">Want to barter tradeshows services</div>
                                <div class="option" data-value="Want our team to find relevant tradeshows for your products/industry">Want our team to find relevant tradeshows for your products/industry</div>
                            </div>
                        </div>
                        <select name="partnership[]" id="partnership-hidden" multiple style="display:none;">
                            <option value="Want to promote my event">Want to promote my event</option>
                            <option value="Want to participate in event as Exhibitor">Want to participate in event as Exhibitor</option>
                            <option value="Want to participate in event as Buyer">Want to participate in event as Buyer</option>
                            <option value="Want to discuss marketing partnership">Want to discuss marketing partnership</option>
                            <option value="Want to barter tradeshows services">Want to barter tradeshows services</option>
                            <option value="Want our team to find relevant tradeshows for your products/industry">Want our team to find relevant tradeshows for your products/industry</option>
                        </select>
                    </div>
                    ...
                    <div class="radio-join d-flex gap-2 align-items-start">
                        <input type="checkbox" name="OPT_IN" id="ts_OPT_IN" required>
                        <label for="ts_OPT_IN"><span style="color:#0F9EA5;">*</span>By joining. I agree to terms of use, privacy policy, IPR and agree to receive emails related to our services.</label>
                    </div>
                    <div class="submit-btn-gradient mt-3">
                        <button type="submit" id="tsFormBtn" class="gradeint-cta">Join Now</button>
                    </div>
                </form>
            </div>
        </div>
...
(function() {
    ...
    function renderTags() {
        display.innerHTML = '';
        if (!selected.length) {
            display.innerHTML = '<span class="placeholder">What type of tradeshow service you want...</span>';
        } else {
    ...
    var form = document.getElementById('tradeshowApplyForm');
    if (!form) return;
    form.addEventListener('submit', function(e) {
        e.preventDefault();
        var btn = document.getElementById('tsFormBtn');
        var ok  = document.getElementById('tsFormSuccess');
        var err = document.getElementById('tsFormError');
